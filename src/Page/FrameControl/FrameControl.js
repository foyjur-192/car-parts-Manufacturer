              ...
              <div class="lg:w-4/5 mx-auto flex flex-wrap">
                ...
                <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0 ">
                  ...
                  <div className='text-left'>
                    <p class="leading-relaxed"><span className='font-medium mr-3'>Material:</span>  Plastic</p>
                    <span className='h-1 bg-secondary'></span>
                    <p class="leading-relaxed"><span className='font-medium  mr-3'>Usage/Application:</span> Car</p>
                    <span className='h-1 bg-secondary'></span>
                    <p class="leading-relaxed"> <span className='font-medium  mr-3'> Color:</span>  Beige</p>
                    <span className='h-1 w-10 bg-secondary'></span>
                    <p class="leading-relaxed"> <span className='font-medium  mr-3'> Weight: </span>      2kg</p>
                    <span className='h-1 bg-secondary'></span>
                    <p class="leading-relaxed">  <span className='font-medium  mr-3'> Asin: </span>     B095SXWB7X</p>
                    <span className='h-1 bg-secondary'></span>
                    <p class="leading-relaxed">  <span className='font-medium mr-3'> Size:</span> 30 x 20 x 20 cm</p>
                    <span className='h-1 bg-secondary'></span>
                  ...
                  <div className='text-left mt-6'>
                      <p className='font-medium text-2xl'><span className='font-normal '>Per Unit Price:</span> ${light.price}</p>
                  </div>
                </div>
              </div>
        </div>
      ...
      <div class="flex flex-wrap text-left -m-2">
        ...
        <div class="p-2 w-full">
          <div class="relative">
            ...
            <input type="cityName"  name="cityName" placeholder='City Name' class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 hover:bg-secondary hover:text-white focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"/>
          </div>
        </div>
        <div class="p-2 w-full">
          <div class="relative">
        ...
        <div class="p-2 w-full mt-5">
          <button class="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">Complete Order</button>
        </div>
      </div>
      </form>
    </div>
