              ...
              <div class="lg:w-4/5 mx-auto flex flex-wrap">
                ...
                <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0 ">
                  ...
                  <div className='text-left'>
                    <p class="leading-relaxed"><span className='font-medium mr-3'>Usage/Application:</span>   Car AC and Heater Control Switch Panel</p>
                    <span className='h-1 bg-secondary'></span>
                    <p class="leading-relaxed"><span className='font-medium  mr-3'>Brand:</span>     Hyundai</p>
                    <span className='h-1 bg-secondary'></span>
                    <p class="leading-relaxed"> <span className='font-medium  mr-3'>Material:</span>   Plastic</p>
                    <span className='h-1 w-10 bg-secondary'></span>
                    <p class="leading-relaxed"> <span className='font-medium  mr-3'> Product Type: </span>    AC Control switch</p>
                    <span className='h-1 bg-secondary'></span>
                    <p class="leading-relaxed">  <span className='font-medium  mr-3'> Model Name/Number: </span> Hyundai Venue</p>
                    <span className='h-1 bg-secondary'></span>
                    <p class="leading-relaxed">  <span className='font-medium  mr-3'> Color: </span> Black</p>
                    <span className='h-1 bg-secondary'></span>
